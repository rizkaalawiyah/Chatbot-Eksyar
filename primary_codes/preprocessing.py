...
# question="anak manusia adalah"
# ques = question.translate(str.maketrans('','', string.punctuation)).lower()
#
...
example_sent = "Dia pawang hujan yang sesungguhnya !"

stopwords_added = stop_word_list
stop_words = stopwords_added+list(punctuation)
